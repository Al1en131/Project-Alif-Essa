...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO datapegawai(nama,jeniskelamin,tempatlahir,tanggallahir,alamat,gol,agama,tanggalkerja) VALUES('$nama','$jeniskelamin','$tempatlahir','$tanggallahir','$alamat','$gol','$agama','$tanggalkerja')");
    if ($result) {
