    ...
    <div id="main" class="container" >
      ...
      <div class="row">
        <div class="col-md-15">
          <div class="card">
            <div class="card-body">
              <a href="tkb.php" class="btn btn-md btn-success" style="margin-top: 10px; margin-bottom: 10px;">TAMBAH DATA</a>
              <table class="table table-bordered table-striped" id="myTable">
                ...
                <tbody>
                  <?php 
                      include('koneksi.php');
                      $id = 101;
                      $result = mysqli_query($mysqli,"SELECT * FROM tkb");
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edittkb.php?id=<?php echo $user_data['id'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="deletetkb.php?id=<?php echo $user_data['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
