...
if(isset($_POST['Submit'])) {
    ...
    $result = mysqli_query($mysqli, "INSERT INTO tka(nama, jeniskelamin, tempatlahir, tanggallahir, anak, hobi, alamat, gol, agama, bapak, ibu, tanggalmasuk)
    ...
    <div id="main" class="container">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <div class="card">
            <div class="card-body">
              <form   action="tka.php" method="POST">
