...
if(isset($_POST['update']))
{
    ...
    // update user data
    $result = mysqli_query($mysqli, "UPDATE tka SET nama='$nama', jeniskelamin='$jeniskelamin', tempatlahir='$tempatlahir', tanggallahir='$tanggallahir', anak='$anak', hobi='$hobi', alamat='$alamat', gol='$gol', agama='$agama', bapak='$bapak', ibu='$ibu', tanggalmasuk='$tanggalmasuk' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM tka WHERE id=$id");
...
<div id="main" class="container" >
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <div class="card">
            <div class="card-body">
              <form action="edittka.php" method="POST">
